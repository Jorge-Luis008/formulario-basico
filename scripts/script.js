...
const municipios = {
    sinaloa: ["1-Ahome","2-Angostura","3-Badiraguato","4-Concordia","5-Cosalá","6-Culiacán","7-Choix","8-Elota","9-Escuinapa","10-El Fuerte","11-Guasave","12-Mazatlán","13-Mocorito","14-El Rosario","15-Salvador Alvarado","16-San Ignacio","17-Sinaloa","18-Navolato","19-Eldorado","20-Juan José Ríos"],
    sonora: ["1-Aconchi","2-Agua Prieta","3-Álamos","4-Altar","5-Arivechi","6-Arizpe","7-Átil","8-Bacadéhuachi","9-Bacanora","10-Bacerac",
    ...
    nayarit: ["1-Acaponeta","2-Ahuacatlán","3-Amatlán de Cañas","4-Compostela","5-Huahicori","6-Ixtlán del Rio","7-Jala","8-Xalisco","9-Del Nayar","10-Rosamorada",
    ...
    durango: ["1-Canatlán","2-Canelas","3-Coneto de Comonfort","4-Cuencamé","5-Durango","6-General Simón Bolívar","7-Gómez Palacio","8-Guadalupe Victoria","9-Guanaceví","10-Hidalgo",
    ...
    chihuahua: ["1-Ahumada","2-Aldama","3-Allende","4-Aquiles Serdán","5-Ascensión","6-Bachíniva","7-Balleza","8-Batopilas de Manuel Gómez Morín","9-Bocoyna","10-Buenaventura",
    ...
    zacatecas: ["1-Apozol","2-Apulco","3-Atolinga","4-Benito Juárez","5-Calera","6-Cañitas de Felipe Pescador","7-Concepción del Oror","8-Cuauhtémoc","9-Chalchihuites","10-Fresnillo",
    ...
    jalisco: ["1-Acatic","2-Acatlán de Juárez","3-Ahualulco de Mercado","4-Amacueca","5-Amatitán","6-Ameca","7-San Juanito de Escobedo","8-Arandas","9-El Arenal","10-Atemajac de Brizuela",
    ...
    nuevoLeon: ["1-Abasolo","2-Agualeguas","3-Los Aldamas","4-Allende","5-Anáhuac","6-Apodaca","7-Aramberri","8-Bustamante","9-Cadereyta Jiménez","10-El Carmen",
            ...
            "51-Villaldama"],
    bajaCalifornia: ["1-Ensenada","2-Mexicali","3-Tecate","4-Tijuana","5-Playas de Rosarito","6-San Quintín","7-San Felipe"],
    bajaCalidorniaSur: ["1-Comondú","2-Mulegé","3-La Paz","4-Los Cabos","5-Loreto"]
}
...
function validarCampos(){
    ...
    if (!nameInput1.value || !nameInput2.value || !nameInput3.value || !streetInput.value || !zipCodeInput.value){
        return false;
    }
    return true;
}
